...
(function attachTabHarborI18n(globalScope) {
  ...
  const i18nMessages = {
    en: {
      ...
      toastClosedExtraTabHarborTabs: 'Closed extra Portus tabs',
      ...
      linksWordPlural: 'links',
      deleteConfirmBookmark: 'Are you sure you want to delete the bookmark "{title}"?\n\nThis action cannot be undone.',
      deleteConfirmFolder: 'Are you sure you want to delete the folder "{title}" and all its contents?\n\nThis will permanently remove every bookmark inside this folder. This action cannot be undone.',
      folderLabel: 'Folder',
    ...
    'zh-CN': {
      ...
      toastClosedExtraTabHarborTabs: '已关闭多余的 Portus 标签页',
      ...
      bookmarksLabel: '书签',
      addToBookmarks: '加入书签',
      toastBookmarked: '已加入书签',
      quickLinksLabel: '快捷链接',
      libraryLabel: '书签库',
      linksWordPlural: '个链接',
      deleteConfirmBookmark: '确定要删除书签 "{title}" 吗？\n\n此操作无法撤销。',
      deleteConfirmFolder: '确定要删除文件夹 "{title}" 及其所有内容吗？\n\n这将永久移除该文件夹内的所有书签。此操作无法撤销。',
      folderLabel: '文件夹',
      untitledLabel: '无标题',
      emptyFolderMessage: '文件夹为空。',
  ...
  const i18nTextMapZh = {
    ...
    'Close extras': '关闭多余标签',
    'You have': '你当前有',
    'Portus tabs open. Keep just this one?': '个 Portus 标签页已打开。仅保留当前这个？',
